...
ManifestSerializer::Error::operator ManifestSerializer::ErrorType() const {
    return type;
}
...
ManifestSerializer::Error ManifestSerializer::serializeOctopusStatusValue(octopus::Status::Value const &value) {
    switch (value) {
        case octopus::Status::Value::READY: write("\"READY\""); break;
        case octopus::Status::Value::PENDING: write("\"PENDING\""); break;
        case octopus::Status::Value::PROCESSING: write("\"PROCESSING\""); break;
        case octopus::Status::Value::FAILED: write("\"FAILED\""); break;
        default:
            return Error(ErrorType::UNKNOWN_ENUM_VALUE, &value);
    }
    return ErrorType::OK;
